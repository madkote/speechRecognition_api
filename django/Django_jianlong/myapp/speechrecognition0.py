...
clffa = joblib.load('myapp/cfl_age.pkl')
clffg = joblib.load('myapp/gender.joblib')
def feature(audio_path):
    ...
    return features
def genderageRecognition(filename):
...
def speechRecognition(filename,status,message):
